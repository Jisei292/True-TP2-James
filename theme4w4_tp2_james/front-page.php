...
<!-- ////////////////////////////////////////////////
formulaire ajout d'article de categorie << Nouvelles >> -->
		<section class="admin-rapid">
			<h3>Ajouter un article de categorie "Nouvelles"</h3>
			<input typ="text" name="title" placeholder="Titre">
			<textarea name="content" placeholder="Contenu"></textarea>
			<button id="bout-rapide">Créer une Nouvelle</button>
		</section>
			<section class="nouvelles"> <!-- les nouvelles -->
			    <button id="bout_nouvelle"> Derniere Nouvelles</button>
				<section>
				</section>
			</section>
		<?php endif; ?>
